...
This project was developed with the help of AI coding assistants, including Claude, ChatGPT and Codex, at various implementation
stages.

AI tools were used for:
- Drafting and refactoring pipeline scripts (ingestion, embedding, retrieval)
- Drafting a small initial set of test cases
- Debugging and explaining errors
- Brainstorming schema design and project structure
- Writing documentation, including parts of this README

Architectural decisions, data modeling choices, and evaluation design were
made by me, with AI tools used as a sounding board, for example proposing tradeoffs and
alternatives that I evaluated and chose between. AI-generated code was reviewed, tested, and modified before
being committed. The personal movie data (notes, ratings, likes/dislikes) is
entirely my own, no AI-generated content is included in the raw dataset.
